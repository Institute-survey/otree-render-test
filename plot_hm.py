...
# データ格納
data = defaultdict(lambda: defaultdict(dict))  # data[norm][benefit][prob] = avg
...
for subdir in os.listdir(base_dir):
    ...
    for file in files:
        try:
            ...
            data[norm][benefit][prob] = mean_val
